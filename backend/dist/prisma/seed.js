...
async function main() {
    ...
    const questions = [
        { id: 'q1', text: 'Quanto é 2 + 2?', type: 'MULTIPLE_CHOICE', options: JSON.stringify(['3', '4', '5', '6']), correctAnswer: '4', points: 2 },
        { id: 'q2', text: 'Quanto é 10 × 5?', type: 'MULTIPLE_CHOICE', options: JSON.stringify(['45', '50', '55', '60']), correctAnswer: '50', points: 2 },
        { id: 'q3', text: 'Quanto é 100 ÷ 4?', type: 'MULTIPLE_CHOICE', options: JSON.stringify(['20', '25', '30', '35']), correctAnswer: '25', points: 2 },
    ];
